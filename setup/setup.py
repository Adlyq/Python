...
if __name__ == '__main__':
    ...
    os.system(
        'echo y |sudo pacman -Rs  jre8-openjdk jre8-openjdk-headless ms-office-online empathy simple-scan manjaro-printer system-config-printer cups-pk-helper gnome-user-docs gnome-getting-started-docs yelp gnome-notes gnome-contacts imagewriter lollypop gnome-todo totem gedit libreoffice-still')
    os.system(
        'sudo pacman -S fcitx-im fcitx-sogoupinyin fcitx-configtool wine_gecko wine-mono winetricks-zh wine jdk8  netease-cloud-music gimp firefox firefox-i18n-zh-cn wps-office cmake make gcc gdb visual-studio-code-bin clion deepin.com.qq.im gnome-terminal-fedora exfat-utils  dsniff net-tools advcp deepin-system-monitor deepin-music deepin-editor deepin-movie d flashplugin deepin-movie virtualbox virtualbox-guest-utils virtualbox-guest-iso linux419-virtualbox-host-modules')
    os.system('yaourt -Sy deepin.com.thunderspeed')
    os.system("alias -s cp='cp -g'")
    os.system("alias -s mv='mv -g'")
